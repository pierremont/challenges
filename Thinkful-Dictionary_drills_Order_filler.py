'''Thinkful - Dictionary drills: Order filler (codewars.com, 8kyu)
...
def fillable(stock, merch, n):
    return stock.get(merch, 0) >= n  # we have to use .get, otherwise if the key doesn't exist, the script fails

stock = {'cizme':1, 'bocanci':5, 'sosete':3}
print(fillable(stock, 'pantofi', 3))
